...
mod tests {
    ...
    use riggen_core::{Command, InertialSpec, Joint, Link, MeshAsset};
    ...
    impl Builder {
        ...
        fn mesh(&mut self, stem: &str, mesh: TriMesh) -> MeshId {
        ...
        fn geom(&mut self, mesh: MeshId, pose: Pose) -> Geom {
            Geom {
        ...
        fn resolve(&self) -> Result<ResolvedRobot, Vec<ExportError>> {
